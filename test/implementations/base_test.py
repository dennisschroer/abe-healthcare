...
class ImplementationBaseTestCase(unittest.TestCase):
    ...
    def setup_abe(self):
        ...
        self.registration_data = self.ca.register_user('alice')
        self.subject.update_secret_keys(self.secret_keys, self.ma1.keygen_valid_sttributes('alice', self.registration_data, ['ONE@A1'], 1))
        self.subject.update_secret_keys(self.secret_keys, self.ma2.keygen_valid_sttributes('alice', self.registration_data, ['THREE@A2'], 1))
        ...
        self.subject.update_secret_keys(self.all_secret_keys,
                                        self.ma1.keygen_valid_sttributes('alice', self.registration_data, ['ONE@A1', 'TWO@A1'], 1))
        self.subject.update_secret_keys(self.all_secret_keys,
                                        self.ma2.keygen_valid_sttributes('alice', self.registration_data, ['THREE@A2', 'FOUR@A2'], 1))
        ...
        self.subject.update_secret_keys(self.not_enough_secret_keys,
                                        self.ma1.keygen_valid_sttributes('alice', self.registration_data, ['ONE@A1'], 1))
        ...
        self.subject.update_secret_keys(self.invalid_time_keys,
                                        self.ma1.keygen_valid_sttributes('alice', self.registration_data, ['ONE@A1', 'TWO@A1'], 2))
        self.subject.update_secret_keys(self.invalid_time_keys,
                                        self.ma2.keygen_valid_sttributes('alice', self.registration_data, ['THREE@A2', 'FOUR@A2'], 2))
